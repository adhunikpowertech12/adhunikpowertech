...
export default function FireAndSafety() {
  ...
  const items = [
    ...
    {
      id: 2,
      imgSrc: 'https://res.cloudinary.com/ddkyx2jhh/image/upload/v1766038035/professional_fire_services_mkd8af.webp',
      imgAlt: 'fireman',
      title: 'Professional fire Services provider',
    ...
    {
      id: 3,
      imgSrc: 'https://res.cloudinary.com/ddkyx2jhh/image/upload/v1766040003/bestprices_xoelfe.webp',
      imgAlt: 'a five-star rating, highlighting excellent service quality, positive customer feedback, and high satisfaction level',
      title: 'Best Price',
