...
export default function AirHandling() {
  ...
  const features = [
    {
      id: 1,
      description:
        "Wide range of products (Double Skin Comfort & Clean Room Air Handling Unit) Starts from capacity 500CFM to 50000 CFM.",
      icon: (
        <svg
    ...
    },
    {
      id: 2,
      description:
        " MS powder coated body and SS-304 also available as per requirement.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
  ...
  const energySystems = [
    {
      ...
      desc: (
        <ul className="list-disc list-inside">
          <li>
            Our Double Skin Comfort AHUs are the perfect solution for large
            commercial spaces where superior air quality and thermal comfort are
            paramount. The double-skin construction provides excellent thermal
            insulation and acoustic performance, ensuring quiet and efficient
            operation.
          </li>
          <span>
            <strong className="text-cyan-500"> Ideal For :</strong>
          </span>
          <li>Corporate Offices & Commercial Buildings</li>
          <li>Hotels, Malls & Multiplexes</li>
          <li>Hospitals & Educational Institutions</li>
          <li>Large-Scale Industrial Sheds</li>
        </ul>
      ),
    ...
    },
    {
      ...
      desc: (
        <ul className="list-disc list-inside">
          <li>
            For industries where air purity is non-negotiable, our Cleanroom
            AHUs are engineered to meet the strictest standards. Designed with
            smooth, non-porous surfaces and easy-to-clean interiors, these units
            are crucial for preventing microbial growth and ensuring a
            contaminant-free environment.
          </li>
          <span>
            <strong className="text-cyan-500"> Ideal For :</strong>
          </span>
          <li>Pharmaceutical & Biotechnology Labs</li>
          <li>Hospitals (Operating Theaters & ICUs)</li>
  ...
  const energySystems2 = [
    {
      ...
      desc: (
        <ul className="list-disc list-inside">
          <li>
            We offer a full range of products, with capacities starting from 500
            CFM to 50,000 CFM, ensuring a perfectly sized solution for any
            project.
          </li>
        </ul>
      ),
    },
    {
      ...
      desc: (
        <ul className="list-disc list-inside">
          <li>
            Our units feature a double-skin panel design that minimizes heat loss,
            reduces operational noise, and enhances structural rigidity.
          </li>
        </ul>
      ),
    },
    {
      ...
      desc: (
        <ul className="list-disc list-inside">
          <li>
            We offer construction in both heavy-duty Powder Coated GI and
            corrosion-resistant Stainless Steel (SS-304) to suit your specific
            application.
          </li>
        </ul>
      ),
    },
    {
      ...
      desc: (
        <ul className="list-disc list-inside">
          <li>
            Our AHUs can be configured with a multi-stage filtration system,
            including pre-filters, bag filters, and high-efficiency HEPA
            filters, to achieve the required level of air purity.
          </li>
        </ul>
      ),
    },
    {
      ...
      desc: (
        <ul className="list-disc list-inside">
          <li>
            We use high-quality, energy-efficient blowers, motors, and cooling
            coils to maximize performance and minimize operational costs.
          </li>
        </ul>
      ),
    },
    {
      ...
      desc: (
        <ul className="list-disc list-inside">
          <li>
            All spare parts are treated with a rust-free, anti-corrosion coating
            to ensure a long and trouble-free service life.
          </li>
        </ul>
      ),
    },
  ...
  return (
    <div className="row mt-32 font-sans">
      <div className="row">
        <h1 className="w-full text-center font-sans text-2xl text-cyan-600 uppercase">
        ...
        <div className="h-full flex flex-col md:flex-row text-center p-5 bg-[#F4F4F4] m-4">
              ...
              <div>
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-xl">
                  ...
                  <div className="absolute inset-0 flex translate-y-[50%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                    <p className="font-dmserif text-3xl font-bold text-white">
                      Air Handling Unit
                    </p>
                    <p className="mb-3 pt-2 text-sm italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      Experience the perfect blend of style and performance that
                      elevates your environment. Contact us today for a free
                      consultation and discover how to create a cooler, more
                      comfortable space.
                    </p>
                  </div>
                </div>
          ...
          <div className="md:w-[60%] w-auto h-full p-2 m-2 md:p-5 md:m-5 text-center">
            ...
            <p className="text-justify text-sm">
              Experience Unparalleled Air Quality, Precise Temperature Control,
              and Exceptional Energy Efficiency with Adhunik Powertech’s
            ...
            <p className="text-justify text-sm">
              The Air Handling Unit (AHU) is the central component of your HVAC
              system, acting as the &quot;lungs&quot; of your building. It is
              responsible for conditioning and circulating air, ensuring that
              every corner of your facility receives a consistent supply of
              clean, fresh, and temperature-controlled air. A high-quality,
              properly engineered AHU is fundamental to achieving superior indoor
              air quality (IAQ), thermal comfort, and energy efficiency.
              <br />
              Adhunik Powertech manufactures a wide range of robust and reliable
              AHUs, designed to meet the most demanding requirements of
              commercial, industrial, and specialized environments.
            </p>
              ...
              <button
                ...
                onClick={() => {
                  window.location.href =
                    "mailto:info@adhunikpowertech.com?subject=Enquiry%20Now&body=Hello,%20I%20would%20like%20to%20enquire%20about%20your%20services.";
                }}
              >
                Enquiry Now
              </button>
        ...
        <div className="bg-[#283e56] p-4 relative">
          ...
          <div className="max-w-7xl mx-auto px-6 py-4 md:px-12 xl:px-6">
            <div className="md:w-2/3 lg:w-1/2 mt-2 text-gray-100 flex items-center">
              ...
              <h2 className="text-2xl font-bold text-white md:text-4xl ps-3">
                Product Features
              </h2>
            </div>
                  ...
                  <div className="relative space-y-8 py-12 p-8">
                    <div className="space-y-2">
                      <ul className="list-none flex flex-row">
                        <div className="h-full w-fit pe-3 text-[#eff0f4]">
                          {feature.icon}
                        </div>
                        <li className="text-[#F1F2FD] text-[14px]">
                          {feature.description}
                        </li>
                      </ul>
                    </div>
      ...
      <div className="mb-12 px-4 md:px-24 pt-24">
        <p className="text-sm pb-4 text-cyan-900">
          ...
          <br />
          We offer a comprehensive range of AHUs, including both Comfort AHUs
          for general applications and highly specialized Cleanroom AHUs for
      ...
      <div className="mb-12 px-4 md:px-24 py-2">
        <p className="text-sm pb-4 text-cyan-900">
          ...
          <br />
          Every Adhunik Powertech AHU is built with a focus on quality,
        ...
        <p className="text-center pt-7 text-sm pb-4 text-cyan-900">
          ...
          <br />
          Our team of technical experts is ready to help you select and configure
          the perfect Air Handling Unit for your specific needs.
        </p>
      </div>
