        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap">
            <div className="w-full">
              ...
              <section>
                <div className="blog-img mb-6 text-center">
                  <div className="flex gap-4 md:gap-9  justify-evenly items-center  flex-col md:flex-row">
                    <div className=" w-full md:w-6/12 flex justify-center items-center  rounded-lg shadow-sm  ">
                    ...
                    <header className=" w-full md:w-6/12 md:text-left text-center text-gray-800 mb-6 flex md:items-start md:justify-start justify-center items-center flex-col mt-2">
                      <h1 className="   md:text-3xl font-bold">What is an Air Washer ?</h1>
                      <p className="text-gray-600 text-sm text-justify text-[15px] pt-3  md:text-[14px] ">  <Link
                        href="/air-washer"
              ...
              <ul className="list-disc pl-5  text-sm text-justify text-gray-600 space-y-2">
                <li>
                  <strong className=' text-cyan-600'>Air Cooling : </strong> Air Washers are used to cool large industrial
                  spaces or similar environments.
                </li>
                <li>
                  <strong className=' text-cyan-600'>Improved Air Quality :</strong> The cooling pads act as natural filters,
                  trapping dust, pollen, and other airborne irritants that can trigger allergies and asthma.
                </li>
                <li>
                  <strong className=' text-cyan-600'>Maintained Humidity :</strong> Unlike air conditioners that can dry out
              ...
              <h3 className=" md:text-xl font-medium mb-2 pt-3">
                Are you thinking about getting an air washer ?
              </h3>

              <p className="mb-4 text-sm text-justify text-gray-700 font-normal">
              ...
              <section>
                <div className="blog-img mb-6 text-center">
                  <div className="flex gap-4 md:gap-9   justify-around items-center  flex-col md:flex-row-reverse">
                    <div className=" w-full md:w-4/12 flex justify-center items-center  rounded-lg shadow-sm  ">
                    ...
                    <div className=" w-full md:w-6/12 text-center text-gray-800 mb-6 flex justify-center items-center flex-col mt-2">
                      <h2 className="   md:text-2xl font-bold">    Best Industrial Air Washer Manufacturer in India</h2>
                      <p className="text-gray-600 text-sm text-justify pt-3 text-[15px]  md:text-[14px] ">     <Link
                  href="/"
                  className="text-blue-500 hover:underline pr-1 "
                >
                  Adhunik Powertech {" "}
              ...
              <div className="features-list">
                <ul className="list-disc text-justify text-sm pl-5 text-gray-700 space-y-2">
                  {features.map((feature, index) => (
                    <li key={index} className="font-normal text-sm">
                      <span className="font-bold text-cyan-600">{feature.title} :</span> {feature.description}
                    </li>
                  ))}
                </ul>
                ...
                <div className="blog-img mb-6 text-center">
                  <div className="flex gap-4 md:gap-9  justify-evenly items-center  flex-col md:flex-row">
                    ...
                    <div className=" w-full md:w-6/12  text-gray-800 mb-6 flex justify-start flex-col mt-2">
                      <h2 className=" text-lg  md:text-3xl  text-left font-bold"> Conclusion</h2>
