...
export const metadata = {
  ...
  keywords: [
    ...
    "Industrial Panel AC",
    "Government Supplier Panel AC",
    "Authorized Panel AC Supplier",
    "Top Panel AC Manufacturer",
    "Heavy Duty Panel AC",
    "Low Maintenance Panel AC",
    "Durable Panel AC",
    "Adhunik Powertech Panel AC",
    "Panel AC for Pharmaceutical",
    "Panel AC for Food Processing",
    "Panel AC for Engineering",
    "Panel AC for Manufacturing",
    "CNC Panel Cooling",
    "VFD Panel Cooling",
    ...
    "Panel air conditioner for CNC machines",
    "Panel air conditioner for VFD drives",
    "Best panel air conditioner for industrial use",
    "Reliable electrical panel cooling solutions",
    "Authorized panel air conditioner supplier",
    "Panel AC maintenance and support",
    ...
    images: [
      {
        ...
        width: 800,
        height: 600,
        alt: "Adhunik Powertech Panel AC Units",
      },
    ],
  },
  alternates: {
