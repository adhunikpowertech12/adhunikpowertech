...
export const metadata = {
  ...
  openGraph: {
    title: "HVAC Excellence: 20 Years of Innovation | Adhunik Powertech",
    description: "Adhunik Powertech: 20 years of HVAC leadership in Delhi. Learn expert formulas, thumb rules, & real case studies for commercial & cleanroom efficiency.",
    url: "https://www.adhunikpowertech.com/hvac-thumb-rule-and-formulas", // Placeholder: Adjust to your actual blog post URL
    type: "article",
    images: [
      {
  ...
  robots: "index, follow",
  alternates: {
    canonical: "https://www.adhunikpowertech.com/hvac-thumb-rule-and-formulas", // Placeholder: Adjust to your actual canonical URL for this blog post
  },
  twitter: {
