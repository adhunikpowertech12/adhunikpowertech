...
export default function HvacRightContractor() {
  return (
    <>
    ...
    <div className="container mx-auto p-6 mt-32">
      ...
      <h2 className="text-2xl font-bold mt-6">Deciphering HVAC: A Holistic Approach to Indoor Climate Control
</h2>
      <p>
