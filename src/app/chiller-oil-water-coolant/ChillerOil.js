                    ...
                    <div className="w-auto">
                      <div className="w-full object-cover transition-transform duration-500 group-hover:scale-125 rounded-xl">
                        <img
                          ...
                          decoding="async"
                          alt="1.5 Tr Chiller"
                          src="https://res.cloudinary.com/ddkyx2jhh/image/upload/v1773317367/1.5_ltr_chiller_appp8e.webp"
                          loading="lazy"
                          height="300"
                          width="300"
                        />
                    ...
                    <div className="w-auto">
                      <div className="w-full object-cover transition-transform duration-500 group-hover:scale-125 rounded-xl">
                        <img
                          ...
                          decoding="async"
                          alt="3_tr_chiller"
                          src="https://res.cloudinary.com/ddkyx2jhh/image/upload/v1773317328/3_tr_chiller_vqrtie.webp"
                          loading="lazy"
                          height="300"
                          width="300"
                        />
                    ...
                    <div className="w-auto">
                      <div className="w-full object-cover transition-transform duration-500 group-hover:scale-125 rounded-xl">
                        <img
                          ...
                          decoding="async"
                          alt="5tr Chiller"
                          src="https://res.cloudinary.com/ddkyx2jhh/image/upload/v1773317327/5_tr_chiller_ysx0ab.webp"
                          loading="lazy"
                          height="300"
                          width="300"
                        />
                    ...
                    <div className="w-auto">
                      <div className="w-full object-cover transition-transform duration-500 group-hover:scale-125 rounded-xl">
                        <img
                          ...
                          loading="lazy"
                          alt="8Tr Chiller"
                          src="https://res.cloudinary.com/ddkyx2jhh/image/upload/v1773317327/8_Tr_Chiller_q2kva4.webp"
                          height="300"
                          width="300"
                        />
                      </div>
