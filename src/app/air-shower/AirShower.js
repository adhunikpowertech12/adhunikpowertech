...
export default function AirShower() {
  ...
  const features = [
    {
      ...
      description: (
        <p>
          <strong className="text-cyan-600 text-lg">High-Velocity Air Jets : </strong>
          <br />Strategically placed nozzles deliver air streams at high velocity for effective, full-body decontamination.
        </p>
      ),
      icon: (
        <svg
    ...
    },
    {
      ...
      description: (
        <p>
          <strong className="text-cyan-600 text-lg">Integrated HEPA Filtration : </strong>
          <br /> An integrated HEPA filtration system ensures the air used for cleaning is pristine, with an efficiency of <strong className="font-bold text-cyan-500">99.97% at 0.3 microns.</strong>
        </p>
      ),
      icon: (
        <svg
    ...
    },
    {
      ...
      description: (
        <p>
          <strong className="text-cyan-600 text-lg">Door Interlocking System : </strong>
          <br /> A standard electromagnetic interlocking system prevents both doors from being opened simultaneously, maintaining pressure differentials and preventing cross-contamination. Available in robust Stainless Steel (SS 304) or heavy-duty Powder Coated GI.
        </p>
      ),
      icon: (
        <svg
    ...
    },
    {
      ...
      description: (
        <p>
          <strong className="text-cyan-600 text-lg">Full Customization : </strong>
          <br /> We offer complete customization, including size, number of nozzles, and entry/exit configurations to perfectly fit your facility's layout and workflow.
        </p>
      ),
      icon: (
        <svg
  ...
  const features2 = [
    {
      ...
      description: (
        <p>
          <strong className="text-cyan-600 text-lg">Mechanical & Electromagnetic Interlocking : </strong>
          <br /> Prevents cross-contamination by ensuring only one door can be opened at a time.
        </p>
      ),
      icon: (
        <svg
    ...
    },
    {
      ...
      description: (
        <p>
          <strong className="text-cyan-600 text-lg">UV Germicidal Light : </strong>
          <br /> An integrated UV light sterilizes the internal chamber, neutralizing microorganisms and ensuring the aseptic integrity of transferred materials.
        </p>
      ),
      icon: (
        <svg
    ...
    },
    {
      ...
      description: (
        <p>
          <strong className="text-cyan-600 text-lg">Durable & Easy-to-Clean : </strong>
          <br /> Constructed from high-grade stainless steel with smooth, coved corners for easy cleaning and sterilization.
        </p>
      ),
      icon: (
        <svg
  ...
  return (
    <div className="row mt-32 font-sans">
      <h1 className="w-full text-center font-sans text-3xl md:text-5xl text-cyan-600 uppercase">
        Air Shower & Pass Box
      </h1>
        ...
        <div className="h-full flex flex-col md:flex-row text-center p-5 bg-[#F4F4F4] m-4">
                ...
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-xl">
                  ...
                  <div className="absolute inset-0 flex translate-y-[50%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                    ...
                    <p className="mb-3 pt-2 text-sm italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      Ensure a clean and contaminant-free environment with our high-performance Air Showers. Our powerful units effectively remove dust, debris, and particles, enhancing workplace safety.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="md:w-[60%] w-auto h-full p-2 m-2 md:p-5 md:m-5 text-center">
            ...
            <p className="text-sm text-justify md:text-center">
              Our Air Shower is a self-contained, high-efficiency chamber designed to effectively remove surface contaminants from personnel before they enter a cleanroom or sterile environment. High-velocity jets of HEPA-filtered air blow across the individual, dislodging and removing dust, lint, and other particulate matter, ensuring a clean transition and protecting your critical processes.
              <br />
          ...
          <div className="overflow-x-auto w-full max-w-6xl">
            <table className="min-w-full text-sm text-left rtl:text-right text-gray-500 border-collapse border border-gray-200">
              <caption className="uppercase text-base font-semibold text-gray-700 mb-2">
                Air Shower TECHNICAL SPECIFICATION
              </caption>
        ...
        <div className="bg-[#283e56] p-4 relative">
          ...
          <div className="max-w-7xl mx-auto px-6 py-4 md:px-12 xl:px-6">
            <div className="md:w-2/3 lg:w-1/2 mt-2 text-gray-100 flex items-center">
              ...
              <h2 className="text-2xl font-bold text-white md:text-4xl ps-3">Key Features & Benefits</h2>
            </div>
      ...
      <div className="row">
              ...
              <div>
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-xl">
                  ...
                  <div className="absolute inset-0 flex translate-y-[50%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                    ...
                    <p className="mb-3 pt-2 text-sm italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      Protect your cleanroom investment with our essential Pass Box. Designed for the safe transfer of materials between areas with different cleanliness levels, it minimizes contamination and ensures the integrity of your controlled settings.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="h-full flex flex-col-reverse md:flex-row-reverse text-center p-5 bg-[#F4F4F4] m-4">
          <div className="md:w-[60%] w-auto h-full p-2 m-2 md:p-5 md:m-5 text-center">
            <h2 className="md:text-2xl mb-3 hidden md:block">Static Pass Box</h2>
            <p className="text-justify text-sm md:text-center">
            ...
            <div className="flex items-center justify-center h-full">
              <div>
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
                  <div className="absolute inset-0 flex translate-y-[50%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                    <p className="font-dmserif text-2xl font-bold text-white">Static Pass Box</p>
                    <p className="mb-3 pt-2 text-sm italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      Designed for the safe transfer of materials between areas with different cleanliness levels, it minimizes contamination and ensures the integrity of your controlled settings.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="h-full flex flex-col-reverse md:flex-row text-center p-5 bg-[#F4F4F4] m-4">
          <div className="md:w-[60%] w-auto h-full p-2 m-2 md:p-5 md:m-5 text-center">
            <h2 className="md:text-2xl mb-3 hidden md:block">Dynamic Pass Box</h2>
            <p className="text-justify text-sm md:text-center">
            ...
            <div className="flex items-center justify-center h-full">
              <div>
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
                  <div className="absolute inset-0 flex translate-y-[50%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                    <p className="font-dmserif text-2xl font-bold text-white">Dynamic Pass Box</p>
                    <p className="mb-3 pt-2 text-sm italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      Designed for the safe transfer of materials between areas with different cleanliness levels, it minimizes contamination and ensures the integrity of your controlled settings.
                    </p>
                  </div>
      ...
      <div className="row pb-16 flex justify-center items-center flex-col">
        <div className="row w-full h-full">
          <div className="relative overflow-x-auto justify-center items-center flex flex-col font-sans font-thin">
            <table className="md:w-[50%] text-sm text-center text-gray-500">
              <caption className="uppercase text-base font-semibold text-gray-600 mb-2">
                <span className="block text-cyan-700 font-bold mb-1">
