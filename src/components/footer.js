  ...
  return (
    <footer className="  text-[10px] font-sans text-center h-auto w-auto bg-black text-white lg:text-left lg:px-14 py-5">
      ...
      <div className="  pt-8 text-center md:text-left pb-5 border-b border-gray-100">
        <div className="grid-1 grid gap-2  md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6  text-center">
          ...
          {[...Array(1)].map((_, index) => (
            <div key={index}>
              <h2 className="mb-2 text-[15px] font-sans flex justify-center  text-center font-semibold uppercase ">
                PRODUCT
              </h2>
              {links.map((link, idx) => (
