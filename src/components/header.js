              ...
              <div className="row text-right flex flex-row justify-end items-center">
                ...
                <div className="row flex flex-col  md:flex-row">
                  <div className="col flex justify-center items-center">   
                    <svg xmlns="http://www.w3.org/2000/svg" className="px-2 lucide lucide-search-icon lucide-search" onClick={() => setShowSearch(!showSearch)} width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/></svg>
                  ...
                  <div className="col">
                    ...
                    >
                      {isPlaying ? (
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-headphones-icon lucide-headphones">
